...
function loadNavbar(currentPage = '') {
    ...
    const navLinks = navItems.map(item => {
        const isActive = currentPage === item.href || 
                        (currentPage === '' && item.href === 'dashboard.html') ||
                        (currentPage.includes('customer') && item.href === 'customers.html') ||
                        (currentPage.includes('add-customer') && item.href === 'add-customer.html') ||
                        (currentPage.includes('add-payment') && item.href === 'customers.html') ||
                        (currentPage.includes('unpaid') && item.href === 'unpaid.html');
